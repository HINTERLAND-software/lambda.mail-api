...
//   subject:
//     'johannroehl.de: Neuer Kontaktformular Eintrag von bar (foo@bar.com)',
...
//           .fn()
//           .mockReturnValueOnce(
//             `${Date()} | Mail sent to ${resultMailOptions.to}`
//           ),
//       },
//       payload,
//       resultMailOptions.to
...
//       expect(result.html).toContain('href="mailto:foo@bar.com"');
...
//       expect(result.text).toContain(resultMailOptions.text);
//       done();
//     });
//   });
// });
